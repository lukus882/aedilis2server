...
namespace Server.Engines.Help
{
	...
	public class HelpGump : Gump
	{
		...
		public HelpGump( Mobile from ) : base( 0, 0 )
		{
			...
			AddHtmlLocalized( 150, 50, 360, 40, 1001002, false, false ); // <CENTER><U>Aedilis Help Menu</U></CENTER>
			...
			else
			{
				...
				AddHtml( 110, 250, 450, 74, @"<u>I need help with something or I want to report a bug. To do so please visit http://www.aedilis.us and post in the proper forum." , true, true );
