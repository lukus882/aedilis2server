...
namespace Server.Items
{
	...
	public class CustomHuePicker
	{
        ...
        public static readonly CustomHuePicker WoodPaint = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Tan */
				new CustomHueGroup( 1018346, new int[]{ 1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508 } ),
				/* Brown */
        ...
        public static readonly CustomHuePicker StonePaint = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Tan */
				new CustomHueGroup( 1018346, new int[]{ 1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508 } ),
				/* Brown */
        ...
        public static readonly CustomHuePicker MarblePaint = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Violet */
				new CustomHueGroup( 1018345, new int[]{ 1230, 1231, 1232, 1233, 1234, 1235 } ),
				/* Tan */
        ...
        public static readonly CustomHuePicker PlasterPaint = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Dull Copper */
				new CustomHueGroup( 1018332, new int[]{ 2419, 2420, 2421, 2422, 2423, 2424 } ),
				/* Shadow Iron */
        ...
        public static readonly CustomHuePicker SandstonePaint = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Tan */
				new CustomHueGroup( 1018346, new int[]{ 1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508 } ),
				/* Brown */
				...
				/* Yellows */
				new CustomHueGroup( 1018343, new int[]{ 2213, 2214, 2215, 2216, 2217, 2218 } )
			}, true, "Sandstone Paint");

        public static readonly CustomHuePicker OtherWallPaint = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Tan */
				new CustomHueGroup( 1018346, new int[]{ 1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508 } ),
				/* Brown */
