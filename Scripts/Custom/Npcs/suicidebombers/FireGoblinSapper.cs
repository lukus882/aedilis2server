...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public FieryGoblinSapper() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a fiery goblin sapper";
			Body = 17;
			BaseSoundID = 0x45A;
			Hue = 1161;
		...
		public void Explode()
		{
			...
			foreach ( Mobile m in list )
			{
				...
				m.SendMessage( "You take huge damage from the exploding goblin!" );
