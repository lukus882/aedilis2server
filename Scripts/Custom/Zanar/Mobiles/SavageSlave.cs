...
{
	[CorpseName( "a savage slave corpse" )]
	public class SavageSlave : BaseCreature
	{
		[Constructable]
		public SavageSlave() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.Swords, 80.0, 98.5 );
		...
		public override void GenerateLoot()
		{
			...
			AddLoot( LootPack.Gems, Utility.RandomMinMax( 0, 3 ) );
		}
		...
		public SavageSlave( Serial serial ) : base( serial )
		{
		}
