...
namespace Server.Mobiles {
	public class GMEthereal : EtherealMount {
		...
		public override string DefaultName { get { return "A GM's Ethereal Mount"; } }
		public override int FollowerSlots{ get{ return 0; } }
		
		private EtherealTypes m_EthyType;
		
		[Constructable]
		public GMEthereal() : this( EtherealTypes.Horse ) {}
		[Constructable]
		...
		public GMEthereal( Serial serial ) : base( serial ) {}
	...
	public class GMEthVirtual : EtherealMount {
		public GMEthVirtual(int id, int mid) : base( id, mid ) {}
		public GMEthVirtual( Serial serial ) : base( serial ) {}
		public override void Serialize( GenericWriter writer ) {
			base.Serialize( writer );
		}
		public override void Deserialize( GenericReader reader ) {
