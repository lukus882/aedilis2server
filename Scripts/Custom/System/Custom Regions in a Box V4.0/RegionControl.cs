...
namespace Server.Items 
{
    public enum RegionFlag
    {
        ...
        NoPlayerItemDrop    =   0x00100000,
        NoNPCItemDrop   =       0x00200000,
        EmptyNPCCorpse      =   0x00400000,
        EmptyPlayerCorpse   =   0x00800000,
        DeleteNPCCorpse     =   0x01000000,
        DeletePlayerCorpse  =   0x02000000,
        ResNPCOnDeath       =   0x04000000,
        ResPlayerOnDeath    =   0x08000000,
        MoveNPCOnDeath      =   0x10000000,
        MovePlayerOnDeath   =   0x20000000
    }
