...
namespace Knives.Chat3
{
    ...
    public class Data
    {
        ...
        public static void Save()
        {
            ...
            {
                Errors.Report(General.Local(175));
            ...
            {
                Errors.Report(General.Local(228));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
            ...
            {
                Errors.Report(General.Local(230));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
            ...
            {
                Errors.Report(General.Local(232));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
            ...
            {
                Errors.Report(General.Local(234));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
            ...
            {
                Errors.Report(General.Local(236));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
        ...
        public static void Load()
        {
            ...
            {
                Errors.Report(General.Local(174));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
            ...
            {
                Errors.Report(General.Local(227));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
            ...
            {
                Errors.Report(General.Local(229));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
            ...
            {
                Errors.Report(General.Local(231));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
            ...
            {
                Errors.Report(General.Local(233));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
            ...
            {
                Errors.Report(General.Local(235));
                Console.WriteLine(e.Message);
                Console.WriteLine(e.Source);
                Console.WriteLine(e.StackTrace);
            }
        ...
        private int c_GlobalMC, c_GlobalCC, c_GlobalGC, c_GlobalFC, c_GlobalWC, c_SystemC, c_MsgC, c_PerPage, c_DefaultSound, c_StaffC, c_Avatar, c_Karma, c_Warnings;
        ...
        public void AddMessage(Message msg)
        {
            ...
            if (c_WhenFull && c_Messages.Count > s_MaxMsgs)
                DeleteMessage((Message)c_Messages[0]);
        }
