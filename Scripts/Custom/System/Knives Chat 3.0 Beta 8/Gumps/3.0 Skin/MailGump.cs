    ...
    public class MailGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            if (Data.GetData(Current).MsgSound)
            {
                ...
                AddImageTiled(width/2-25, y += 25, 50, 21, 0xBBA);
                AddTextField(width/2-25, y, 50, 21, 0x480, 1, Data.GetData(Current).DefaultSound.ToString());
        ...
        {
            Data.GetData(Current).DefaultSound = Utility.ToInt32(GetTextField(1));
