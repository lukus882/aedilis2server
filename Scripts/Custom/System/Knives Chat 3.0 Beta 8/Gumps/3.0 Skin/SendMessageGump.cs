...
namespace Knives.Chat3
{
    public class SendMessageGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            {
                AddImageTiled(30, y+=20, width-60, 21, 0xBBC);
                AddTextField(30, y, width - 60, 21, Data.GetData(Owner).MsgC, 0, c_Subject);

                AddImageTiled(20, y+=30, width-40, field, 0xBBC);
                AddTextField(20, y, width - 40, field, Data.GetData(Owner).MsgC, 1, c_Text);
        ...
        private void Send()
        {
            ...
            else
            {
                ...
                Owner.SendMessage(GetData.SystemC, General.Local(67) + " " + c_To.RawName);
                if (Data.GetData(c_To).Status != OnlineStatus.Online)
                    Owner.SendMessage(GetData.SystemC, c_To.RawName + ": " + Data.GetData(c_To).AwayMsg);
            }
