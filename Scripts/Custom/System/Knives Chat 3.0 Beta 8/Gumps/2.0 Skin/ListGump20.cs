...
namespace Knives.Chat3
{
    public class ListGump20 : GumpPlus
    {
        ...
        private int ShowFullMenu(int y, int width)
        {
            ...
            AddButton(width / 2 - 20, y+=25, 0x8B2, "2.0", new GumpStateCallback(SkinChange), Skin.Two);
            AddButton(width / 2, y, 0x8B3, "3.0", new GumpStateCallback(SkinChange), Skin.Three);
        ...
        private class FullGump : GumpPlus
        {
            ...
            protected override void BuildGump()
            {
                ...
                foreach (Chat3.Channel c in Chat3.Channel.Channels)
                {
                    ...
                    AddButton(20, y, c.Mobiles.Contains(c_Target) ? 0x2343 : 0x2342, "Join Channel", new GumpStateCallback(JoinChannel), c);

                    if (c.Mobiles.Contains(c_Target))
                    {
            ...
            private void JoinChannel(object o)
            {
                ...
                if (((Channel)o).Mobiles.Contains(c_Target))
                    ((Channel)o).Mobiles.Remove(c_Target);
                else
                    ((Channel)o).Mobiles.Add(c_Target);
