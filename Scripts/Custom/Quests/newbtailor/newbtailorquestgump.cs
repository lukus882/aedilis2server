...
{
	public class NewbTailorQuestGump : Gump
	{
		public NewbTailorQuestGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(250, 151, 1153, @"New Player Smith Quest");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "If you would like to master the arts of tailoring, I can help you by giving your special items. But first, you must prove your dedication to this fine art by getting a few things for me. First find for me some wool, spool of thread, and a bolt of cloth. I need 10 of each. You will be able to find sheep to shear at the HeadMaster's House. You can get there by using the moongate just south of the school. You can use this spinning wheel and loom that I have placed especially for you in the corner.", true, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					from.SendMessage( "I await your return." );
					from.CloseGump( typeof( NewbTailorQuestGump ) );
					from.AddToBackpack(new NewbTailorMarker1());
					break;
				}
				case 1:
				{
					from.SendMessage( "If you change your mind, I'll be here." );
					from.CloseGump( typeof( NewbTailorQuestGump ) );
					break;
				}
			}
