...
{
	public class NewbTailorQuestGump2 : Gump
	{
		public NewbTailorQuestGump2( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(250, 151, 1153, @"New Player Tailor Quest");
			this.AddButton(282, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "Thank you for bringing back the items for me. You have proven that you understand the workings of the tailoring skill. Please accept this reward from me.", true, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( NewbTailorQuestGump2 ) );
					break;
				}
