...
{
	public class NewbSmithQuestGump : Gump
	{
		public NewbSmithQuestGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "If you would like to master the arts of blacksmithing, I can help you by giving your special items. But first, you must prove your dedication to this fine art by getting a few things for me. First find for me 10 iron ingots, 1 katana, and 1 repair deed. Make sure when you come back that you have all your other swords in a safe place for I will pick one at random in your backpack. Consider yourself warned!", true, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( NewbSmithQuestGump ) );
					from.AddToBackpack(new NewbSmithMarker1());
					break;
				}
				case 1:
				{
