...
namespace Server.Engines.Craft
{
	public class DefWitchcraft : CraftSystem
	{
		...
		{
			get { return "<basefont color=#FFFFFF><CENTER>WITCHCRAFT MENU</CENTER></basefont>"; } 
		}
...
// AddRes( index, typeof( Consume2 ), Consume2, qty, Error );
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft( typeof( MuffinsOfHealth ), "Magic Foods", "Muffins of Health", 0.0, 100.0, typeof( Dough ), "Dough", 3, "You don't have enough muffins." );
			AddSkill( index, SkillName.Alchemy, 25.0, 100.0 );
			SetNeedOven( index, true );
/*
			...
			SetNeedOven( index, true );
*/
			index = AddCraft( typeof( BowyerBerry ), "Skill Foods", "Bowyer's Berry", 0.0, 100.0, typeof( Apple ), "Apple", 1, "You don't have an apple." );
			...
			index = AddCraft( typeof( KnightMango ), "Skill Foods", "Knight's Mango", 0.0, 100.0, typeof( Peach ), "Peach", 1, "You don't have a peach." );
			AddSkill( index, SkillName.Alchemy, 30.0, 100.0 );
			SetNeedOven( index, true );

			index = AddCraft( typeof( LumberjackCoconut ), "Skill Foods", "Lumberjack's Coconut", 0.0, 100.0, typeof( Apple ), "Apple", 1, "You don't have an apple." );
			AddSkill( index, SkillName.Alchemy, 30.0, 100.0 );
			SetNeedOven( index, true );
			...
			index = AddCraft( typeof( MageMango ), "Skill Foods", "Mage's Mango", 0.0, 100.0, typeof( Peach ), "Peach", 1, "You don't have a peach." );
			AddSkill( index, SkillName.Alchemy, 30.0, 100.0 );
			SetNeedOven( index, true );
			...
			index = AddCraft( typeof( NecroLime ), "Skill Foods", "Necromancer's Lime", 0.0, 100.0, typeof( Apple ), "Apple", 1, "You don't have an apple." );
			AddSkill( index, SkillName.Alchemy, 30.0, 100.0 );
			SetNeedOven( index, true );
			...
			index = AddCraft( typeof( RogueLemon ), "Skill Foods", "Rogue's Lemon", 0.0, 100.0, typeof( Apple ), "Apple", 1, "You don't have an apple." );
			AddSkill( index, SkillName.Alchemy, 30.0, 100.0 );
			SetNeedOven( index, true );
			...
			index = AddCraft( typeof( ScribeLemon ), "Skill Foods", "Scribe's Lemon", 0.0, 100.0, typeof( Apple ), "Apple", 1, "You don't have an apple." );
			AddSkill( index, SkillName.Alchemy, 30.0, 100.0 );
			SetNeedOven( index, true );

			index = AddCraft( typeof( ShepherdLime ), "Skill Foods", "Shepherd's Lime", 0.0, 100.0, typeof( Apple ), "Apple", 1, "You don't have an apple." );
			AddSkill( index, SkillName.Alchemy, 30.0, 100.0 );
			SetNeedOven( index, true );

			index = AddCraft( typeof( SmithMelon ), "Skill Foods", "Smithy's Melon", 0.0, 100.0, typeof( Watermelon ), "Watermelon", 1, "You don't have a watermelon." );
			AddSkill( index, SkillName.Alchemy, 30.0, 100.0 );
			SetNeedOven( index, true );
			...
			index = AddCraft( typeof( ThiefOrange ), "Skill Foods", "Thief's Orange", 0.0, 100.0, typeof( Peach ), "Peach", 1, "You don't have an orange." );
			AddSkill( index, SkillName.Alchemy, 30.0, 100.0 );
			SetNeedOven( index, true );
