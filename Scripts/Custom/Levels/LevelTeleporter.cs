...
{
    public class LevelTeleporter : Item
    {
        ...
        [Constructable]
        public LevelTeleporter(Point3D pointDest, Map mapDest)
            : this(pointDest, mapDest, false)
        {
        }

        [Constructable]
        public LevelTeleporter(Point3D pointDest, Map mapDest, bool creatures)
            : base(0x1BC3)
        {
            Movable = false;
            Visible = false;
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            list.Add(String.Format("<BASEFONT COLOR={0}>{1}", "#00FF00", m_Required ));
        }
        ...
        public override bool OnMoveOver(Mobile m)
        {
            if (m_Active)
            {
                ...
                if (pm.m_LevelTitle == m_Required)
                {
                    StartTeleport(m);
                    return false;
                }
                pm.SendMessage("You are either too high of a level, or too low, to enter this area");
                return true;
            }
        ...
        public LevelTeleporter(Serial serial)
            : base(serial)
        {
        }
