...
{
	public class ArcaneDemonCostume : Item, IDyable
	{
		...
		[Constructable]
		public ArcaneDemonCostume() : base( 0x2684 )
		{
                        Name = "ArcaneDemon Costume";
		...
		public ArcaneDemonCostume( Serial serial ) : base( serial )
		{
		}
