//Total Skill Teleporter by Nitewender
using System;
using Server;
...
{
	public class SkillTotalTeleporter : Item
	{
		...
		{
			get{ return m_SkillLimit; }
			set{ m_SkillLimit = value; InvalidateProperties(); }
		}
		...
		[Constructable]
		public SkillTotalTeleporter() : this( new Point3D( 0, 0, 0 ), null, false )
		{
		}

		[Constructable]
		public SkillTotalTeleporter( Point3D pointDest, Map mapDest ) : this( pointDest, mapDest, false )
		{
		}

		[Constructable]
		public SkillTotalTeleporter( Point3D pointDest, Map mapDest, bool creatures ) : base( 0x1BC3 )
		{
			Movable = false;
			Visible = false;
		...
		public override bool OnMoveOver( Mobile m )
		{
                                                      ...
                                                      if ( m.SkillsTotal <= m_SkillLimit*10 || m.AccessLevel >= AccessLevel.Counselor )
                                                          {
			if ( m_Active )
			{
			...
			return true;
                                                         ...
                                                         m.SendMessage( "Your total skill is too high to enter!" );
                                                         return false;
		}

		public SkillTotalTeleporter( Serial serial ) : base( serial )
		{
		}
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.WriteEncodedInt( (int) m_SkillLimit );
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 2:
				{
					...
					m_SkillLimit = reader.ReadEncodedInt();
					goto case 1;
				}
				case 1:
				{
