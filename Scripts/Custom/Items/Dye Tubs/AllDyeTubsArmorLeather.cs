...
{
	public class AllDyeTubsArmorLeather : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsArmorLeather(  )
		{
			Name = "Dye Tub [Leather Armor]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsArmorLeatherTarget( this );
			}
			else
			{
		...
		public AllDyeTubsArmorLeather( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsArmorLeatherTarget : Target
		{
			private AllDyeTubsArmorLeather m_Tub;

			public AllDyeTubsArmorLeatherTarget( AllDyeTubsArmorLeather dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
