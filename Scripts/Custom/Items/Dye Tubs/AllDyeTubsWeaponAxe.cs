...
{
	public class AllDyeTubsWeaponAxe : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsWeaponAxe(  )
		{
			Name = "Dye Tub [Axe Weapons]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsWeaponAxeTarget( this );
			}
			else
			{
		...
		public AllDyeTubsWeaponAxe( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsWeaponAxeTarget : Target
		{
			private AllDyeTubsWeaponAxe m_Tub;

			public AllDyeTubsWeaponAxeTarget( AllDyeTubsWeaponAxe dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
