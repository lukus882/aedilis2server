...
{
	public class AllDyeTubsWeaponPoleArm : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsWeaponPoleArm(  )
		{
			Name = "Dye Tub [Polearm Weapons]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsWeaponPoleArmTarget( this );
			}
			else
			{
		...
		public AllDyeTubsWeaponPoleArm( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsWeaponPoleArmTarget : Target
		{
			private AllDyeTubsWeaponPoleArm m_Tub;

			public AllDyeTubsWeaponPoleArmTarget( AllDyeTubsWeaponPoleArm dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
            ...
            BaseWeapon weapon = targeted as BaseWeapon; 
						...
						else if ( weapon.Type == WeaponType.Polearm )
						{
