...
{
	public class AllDyeTubsWeaponSlashing : DyeTub
	{
		...
		[Constructable]
		public AllDyeTubsWeaponSlashing(  )
		{
			Name = "Dye Tub [Slashing Weapons]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsWeaponSlashingTarget( this );
			}
			else
			{
		...
		public AllDyeTubsWeaponSlashing( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsWeaponSlashingTarget : Target
		{
			private AllDyeTubsWeaponSlashing m_Tub;

			public AllDyeTubsWeaponSlashingTarget( AllDyeTubsWeaponSlashing dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
            ...
            BaseWeapon weapon = targeted as BaseWeapon; 
						...
						else if ( weapon.Type == WeaponType.Slashing )
						{
