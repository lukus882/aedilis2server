...
{
	public class AllDyeTubsPotionKeg : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsPotionKeg(  )
		{
			Name = "Dye Tub [Potion Keg]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsPotionKegTarget( this );
			}
			else
			{
		...
		public AllDyeTubsPotionKeg( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsPotionKegTarget : Target
		{
			private AllDyeTubsPotionKeg m_Tub;

			public AllDyeTubsPotionKegTarget( AllDyeTubsPotionKeg dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
