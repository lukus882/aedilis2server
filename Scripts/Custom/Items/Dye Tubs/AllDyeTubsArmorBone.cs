...
{
	public class AllDyeTubsArmorBone : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsArmorBone(  )
		{
			Name = "Dye Tub [Bone Armor]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsArmorBoneTarget( this );
			}
			else
			{
		...
		public AllDyeTubsArmorBone( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsArmorBoneTarget : Target
		{
			private AllDyeTubsArmorBone m_Tub;

			public AllDyeTubsArmorBoneTarget( AllDyeTubsArmorBone dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
