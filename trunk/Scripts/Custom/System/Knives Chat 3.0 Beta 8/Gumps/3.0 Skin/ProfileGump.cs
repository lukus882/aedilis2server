    ...
    public class ProfileGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            if (Owner == c_Target)
            {
                ...
                AddImageTiled(20, y += 20, width - 40, 65, 0xBBC);
                AddTextField(20, y, width - 40, 65, 0x480, 0, Data.GetData(c_Target).Signature);
        ...
        private void ViewOptions(int x)
        {
            ...
            if (Data.GetData(Owner).MsgSound)
            {
                ...
                AddTextField(x + width / 2 - 25, y, 50, 21, 0x480, 0, Data.GetData(Owner).GetSound(c_Target).ToString());
        ...
        {
            Data.GetData(Owner).Signature = GetTextField(0);
        ...
        {
            Data.GetData(Owner).SetSound(c_Target, Utility.ToInt32(GetTextField(0)));
