...
namespace Knives.Chat3
{
    ...
    {
        public enum ListPage { All, Channel, Mail, Friends, Ignores, GIgnores, GListens, Bans }
        ...
        protected override void BuildGump()
        {
            ...
            for (int i = c_Page * perpage; i < (c_Page + 1) * perpage && i < list.Count; ++i)
            {
                ...
                else if (list[i] is Message)
                {
                    ...
                    AddHtml(45, y += 20, 180, ColorFor(msg) + (msg.Read ? "" : "<B>") + msg.Subject, false);
                    AddHtml(45, y += 16, 150, General.Local(60) + " " + msg.From.RawName);
        ...
        private void ShowMenu(int x)
        {
            ...
            foreach (Chat3.Channel c in Chat3.Channel.Channels)
            {
                ...
                AddButton(x+20, y, c.Mobiles.Contains(Current) ? 0x2343 : 0x2342, "Join Channel", new GumpStateCallback(JoinChannel), c);

                if (c.Mobiles.Contains(Current))
                {
            ...
            AddButton(x + width / 2 - 20, y += 25, 0x8B2, "2.0", new GumpStateCallback(SkinChange), Skin.Two);
            AddButton(x + width / 2, y, 0x8B3, "3.0", new GumpStateCallback(SkinChange), Skin.Three);
        ...
        private void ShowSearch(int x)
        {
            ...
            AddImage(x - 8, 10, 0x100);
            AddImageTiled(x + 15, 15, 90, 21, 0xBBC);
            AddTextField(x+15, 15, 90, 21, 0x480, 1, c_TxtSearch);
        ...
        private void Open(object o)
        {
            ...
            new MessageGump(Owner, (Message)o);
        }
        ...
        private void JoinChannel(object o)
        {
            ...
            if (((Channel)o).Mobiles.Contains(Current))
                ((Channel)o).Mobiles.Remove(Current);
            else
                ((Channel)o).Mobiles.Add(Current);
        ...
        private class InternalSort : IComparer
        {
            ...
            public int Compare(object x, object y)
            {
                if (x is Mobile && y is Mobile)
                {
                    ...
                    if (!Data.GetData(((Mobile)x)).NewMsgFrom((Mobile)y) && Data.GetData(((Mobile)y)).NewMsgFrom((Mobile)x))
                        return 1;
                    if (Data.GetData(((Mobile)x)).NewMsgFrom((Mobile)y) && !Data.GetData(((Mobile)y)).NewMsgFrom((Mobile)x))
                        return -1;
        ...
        private class BanGump : GumpPlus
        {
            ...
            protected override void BuildGump()
            {
                ...
                AddHtml(0, y, 150, "<CENTER>" + General.Local(160));

                AddHtml(40, y += 20, 100, General.Local(161));
                AddButton(25, y + 3, 0x2716, "30 minutes", new GumpStateCallback(BanTime), TimeSpan.FromMinutes(30));
                AddHtml(40, y += 20, 100, General.Local(162));
                AddButton(25, y + 3, 0x2716, "1 hour", new GumpStateCallback(BanTime), TimeSpan.FromHours(1));
                AddHtml(40, y += 20, 100, General.Local(163));
                AddButton(25, y + 3, 0x2716, "12 hours", new GumpStateCallback(BanTime), TimeSpan.FromHours(12));
                AddHtml(40, y += 20, 100, General.Local(164));
                AddButton(25, y + 3, 0x2716, "1 day", new GumpStateCallback(BanTime), TimeSpan.FromDays(1));
                AddHtml(40, y += 20, 100, General.Local(165));
                AddButton(25, y + 3, 0x2716, "1 week", new GumpStateCallback(BanTime), TimeSpan.FromDays(7));
                AddHtml(40, y += 20, 100, General.Local(166));
                AddButton(25, y + 3, 0x2716, "1 month", new GumpStateCallback(BanTime), TimeSpan.FromDays(30));
                AddHtml(40, y += 20, 100, General.Local(167));
                AddButton(25, y + 3, 0x2716, "1 year", new GumpStateCallback(BanTime), TimeSpan.FromDays(365));

                AddBackgroundZero(0, 0, 150, y + 40, Data.GetData(c_Target).DefaultBack);
            }
        ...
        private class StatusGump : GumpPlus
        {
            ...
            protected override void BuildGump()
            {
                ...
                AddHtml(40, y, 80, General.Local(19), false);
                AddButton(20, y + 2, 0x2716, "Online", new GumpStateCallback(Status), OnlineStatus.Online);
                AddHtml(40, y += 20, 80, General.Local(20), false);
                AddButton(20, y + 2, 0x2716, "Away", new GumpStateCallback(Status), OnlineStatus.Away);
                AddHtml(40, y += 20, 80, General.Local(21), false);
                AddButton(20, y + 2, 0x2716, "Busy", new GumpStateCallback(Status), OnlineStatus.Busy);
                AddHtml(40, y += 20, 80, General.Local(22), false);
                AddButton(20, y + 2, 0x2716, "Hidden", new GumpStateCallback(Status), OnlineStatus.Hidden);

                AddBackgroundZero(0, 0, 100, y + 40, Data.GetData(Owner).DefaultBack);
            }
