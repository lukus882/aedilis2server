...
namespace Knives.Chat3
{
    public class SpamGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddImageTiled(width/2+10, y, 30, 21, 0xBBA);
            AddTextField(width/2+10, y, 30, 21, 0x480, 0, "" + Data.ChatSpam);
            ...
            AddImageTiled(width/2+10, y, 30, 21, 0xBBA);
            AddTextField(width/2+10, y, 30, 21, 0x480, 1, "" + Data.MsgSpam);
            AddHtml(width/2+45, y, 20, "s");
            AddButton(width / 2 - 5, y + 4, 0x2716, "Submit", new GumpCallback(Submit));

            AddHtml(0, y += 25, width/2-10, "<DIV ALIGN=RIGHT>" + General.Local(146));
            AddImageTiled(width/2+10, y, 30, 21, 0xBBA);
            AddTextField(width/2+10, y, 30, 21, 0x480, 6, "" + Data.RequestSpam);
        ...
        private void Submit()
        {
            Data.ChatSpam = Utility.ToInt32(GetTextField(0));
            Data.MsgSpam = Utility.ToInt32(GetTextField(1));
