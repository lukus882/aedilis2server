...
namespace Knives.Chat3
{
	...
	public class GumpPlus : Gump
	{
        ...
        catch (Exception e) { Errors.Report(String.Format("GumpPlus-> OnResponse-> |{0}|-> {1}-> {2} (More info on Console)", c_Owner, GetType(), name)); Console.WriteLine(e.Message); Console.WriteLine(e.Source); Console.WriteLine(e.StackTrace); }
    }
