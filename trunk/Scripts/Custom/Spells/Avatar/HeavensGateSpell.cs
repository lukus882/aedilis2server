...
{
	public class HeavensGateSpell : AvatarSpell
	{
		...
		public HeavensGateSpell( Mobile caster, Item scroll ) : this( caster, scroll, null )
		{
		}

		public HeavensGateSpell( Mobile caster, Item scroll, RunebookEntry entry ) : base( caster, scroll, m_Info )
		{
			m_Entry = entry;
		}
		...
		public void Effect( Point3D loc, Map map, bool checkMulti )
		{
			...
			InternalItem secondGateb = new InternalItem( Caster.Location, Caster.Map );
				...
				secondGateb.Hue = 1151;
				secondGateb.Name = "Gate";
				gravz=loc.Z;
		...
		{
			private HeavensGateSpell m_Owner;

			public InternalTarget( HeavensGateSpell owner ) : base( 12, false, TargetFlags.None )
			{
				m_Owner = owner;
