...
$Id: //depot/c%23/RunUO Core Scripts/RunUO Core Scripts/Customs/Items/House Teleporter/HouseTeleporterDeed.cs#2 $
...
namespace Server.Items
{
	public class HouseTeleporterDeed : Item, ICraftable
	{
		...
		{
			ArrayList addons = m_FirstHouse.Addons;
		...
		private class GetFirstTarget : Target
		{
			...
			public GetFirstTarget(Mobile from, HouseTeleporterDeed deed)
		...
		private class GetSecondTarget : Target
		{
			...
			public GetSecondTarget(Mobile from, HouseTeleporterDeed deed)
				: base(-1, true, TargetFlags.None)
			{
				m_From = from;
				m_Deed = deed;
		...
		public HouseTeleporterDeed(Serial serial)
			: base(serial)
		{
		}
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			switch (version)
			{
				case 0:
					...
					m_Quality = (TeleporterQuality)reader.ReadEncodedInt();
					break;
			}
		}
		#endregion
