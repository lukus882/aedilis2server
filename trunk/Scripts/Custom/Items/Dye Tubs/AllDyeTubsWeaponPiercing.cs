...
{
	public class AllDyeTubsWeaponPiercing : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsWeaponPiercing(  )
		{
			Name = "Dye Tub [Piercing Weapons]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsWeaponPiercingTarget( this );
			}
			else
			{
		...
		public AllDyeTubsWeaponPiercing( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsWeaponPiercingTarget : Target
		{
			private AllDyeTubsWeaponPiercing m_Tub;

			public AllDyeTubsWeaponPiercingTarget( AllDyeTubsWeaponPiercing dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
            ...
            BaseWeapon weapon = targeted as BaseWeapon; 
						...
						else if ( weapon.Type == WeaponType.Piercing )
						{
