...
{
	public class AllDyeTubsArmorPlate : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsArmorPlate(  )
		{
			Name = "Dye Tub [Plate Armor]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsArmorPlateTarget( this );
			}
			else
			{
		...
		public AllDyeTubsArmorPlate( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsArmorPlateTarget : Target
		{
			private AllDyeTubsArmorPlate m_Tub;

			public AllDyeTubsArmorPlateTarget( AllDyeTubsArmorPlate dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
            ...
            BaseArmor armor = targeted as BaseArmor; 
						...
						else if ( armor.MaterialType == ArmorMaterialType.Plate )
						{
