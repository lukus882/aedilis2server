...
{
	public class AllDyeTubsWeaponStaff : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsWeaponStaff(  )
		{
			Name = "Dye Tub [Staff Weapons]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsWeaponStaffTarget( this );
			}
			else
			{
		...
		public AllDyeTubsWeaponStaff( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsWeaponStaffTarget : Target
		{
			private AllDyeTubsWeaponStaff m_Tub;

			public AllDyeTubsWeaponStaffTarget( AllDyeTubsWeaponStaff dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
