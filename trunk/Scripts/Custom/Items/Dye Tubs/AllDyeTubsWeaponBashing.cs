...
{
	public class AllDyeTubsWeaponBashing : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsWeaponBashing(  )
		{
			Name = "Dye Tub [Bashing Weapons]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsWeaponBashingTarget( this );
			}
			else
			{
		...
		public AllDyeTubsWeaponBashing( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsWeaponBashingTarget : Target
		{
			private AllDyeTubsWeaponBashing m_Tub;

			public AllDyeTubsWeaponBashingTarget( AllDyeTubsWeaponBashing dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
