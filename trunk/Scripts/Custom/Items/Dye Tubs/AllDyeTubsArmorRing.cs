...
{
	public class AllDyeTubsArmorRing : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsArmorRing(  )
		{
			Name = "Dye Tub [Ring Armor]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsArmorRingTarget( this );
			}
			else
			{
		...
		public AllDyeTubsArmorRing( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsArmorRingTarget : Target
		{
			private AllDyeTubsArmorRing m_Tub;

			public AllDyeTubsArmorRingTarget( AllDyeTubsArmorRing dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
