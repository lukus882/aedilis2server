...
{
	public class AllDyeTubsWeaponRanged : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsWeaponRanged(  )
		{
			Name = "Dye Tub [Ranged Weapons]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsWeaponRangedTarget( this );
			}
			else
			{
		...
		public AllDyeTubsWeaponRanged( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsWeaponRangedTarget : Target
		{
			private AllDyeTubsWeaponRanged m_Tub;

			public AllDyeTubsWeaponRangedTarget( AllDyeTubsWeaponRanged dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
