...
{
	public class AllDyeTubsStatuetteMonster : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsStatuetteMonster(  )
		{
			Name = "Dye Tub [Monster Statuette]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsStatuetteMonsterTarget( this );
			}
			else
			{
		...
		public AllDyeTubsStatuetteMonster( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsStatuetteMonsterTarget : Target
		{
			private AllDyeTubsStatuetteMonster m_Tub;

			public AllDyeTubsStatuetteMonsterTarget( AllDyeTubsStatuetteMonster dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
