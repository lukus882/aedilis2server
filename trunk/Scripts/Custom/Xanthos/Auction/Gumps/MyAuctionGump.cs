...
namespace Arya.Auction
{
	...
	public class MyAuctionGump : Gump
	{
		...
		private void MakeGump()
		{
			...
			AddLabel(100, 130, Xanthos.Utilities.Misc.kLabelHue, AuctionSystem.ST[ 11 ] );
			AddLabel(285, 130, Xanthos.Utilities.Misc.kLabelHue, AuctionSystem.ST[ 12 ] );
			AddLabel(100, 165, Xanthos.Utilities.Misc.kLabelHue, AuctionSystem.ST[ 13 ] );
			...
			AddLabel(100, 205, Xanthos.Utilities.Misc.kLabelHue, AuctionSystem.ST[ 14 ] );
