...
{
  public class MysticLegs : LeatherLegs 
   {
...
public MysticLegs( Serial serial ) : base( serial ) 
      { 
      } 
      ...
      public override void OnDoubleClick(Mobile from)
      {
          ...
          {
              if (this.ItemID == 5067) this.ItemID = 5202;
              else if (this.ItemID == 5202) this.ItemID = 5137;
              else if (this.ItemID == 5137) this.ItemID = 10120;
              else if (this.ItemID == 10120) this.ItemID = 7176;
              else if (this.ItemID == 7176) this.ItemID = 5067;
          }
          else
          {
