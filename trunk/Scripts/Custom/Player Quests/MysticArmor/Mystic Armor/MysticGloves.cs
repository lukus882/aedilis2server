...
{
  public class MysticGloves : LeatherGloves 
   {
...
public MysticGloves( Serial serial ) : base( serial ) 
      { 
      } 
      ...
      public override void OnDoubleClick(Mobile from)
      {
          ...
          {
              if (this.ItemID == 5062) this.ItemID = 5200;
              else if (this.ItemID == 5200) this.ItemID = 5140;
              else if (this.ItemID == 5140) this.ItemID = 10130;
              else if (this.ItemID == 10130) this.ItemID = 5062;
          }
          else
          {
