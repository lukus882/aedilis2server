...
{
  public class MysticHelm : LeatherCap 
   {
      ...
      public MysticHelm(Serial serial)
          : base(serial) 
      { 
      } 
	...
	if (from.Backpack != null && IsChildOf(from.Backpack))
          {
              if (this.ItemID == 7609) this.ItemID = 5201;
              else if (this.ItemID == 5201) this.ItemID = 5128;
              else if (this.ItemID == 5128) this.ItemID = 10136;
              else if (this.ItemID == 10136) this.ItemID = 5444;
              else if (this.ItemID == 5444) this.ItemID = 7609;
          }
          else
          {
