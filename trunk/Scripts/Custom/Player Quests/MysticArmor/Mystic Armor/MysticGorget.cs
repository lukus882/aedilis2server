...
{
  public class MysticGorget : LeatherGorget 
   {
      ...
      public MysticGorget(Serial serial)
          : base(serial) 
      { 
      } 
      ...
      public override void OnDoubleClick(Mobile from)
      {
          if (from.Backpack != null && IsChildOf(from.Backpack))
          {
              ...
              else if (this.ItemID == 5139) this.ItemID = 4232;
              else if (this.ItemID == 4232) this.ItemID = 1296;
              else if (this.ItemID == 1296) this.ItemID = 5063;
          }
          else
          {
