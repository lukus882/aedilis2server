	...
	public class Speaker : BaseCreature
	{
		...
		private class SpeakerGump : Gump
		{
			...
			private void MakeGump()
			{
				...
				AddButton( 10, 10, 4029, 4031, 2, GumpButtonType.Reply, 0 );
				AddLabel( 44, 13, 37, "Add a new speech entry" );
				...
				{
					// 10, 11 - 12, 13...
					AddButton( 10, 50 + i * 60, 4005, 4007, 10 + 2 * i, GumpButtonType.Reply, 0 );
					AddButton( 10, 80 + i * 60, 4017, 4019, 11 + 2 * i, GumpButtonType.Reply, 0 );

					AddImageTiled( 50, 50 + i * 60, 240, 50, 3004 );
					AddImageTiled( 51, 51 + i * 60, 238, 48, 2624 );
					AddAlphaRegion( 52, 52 + i * 60, 236, 46 );
					Add( new GumpHtml( 54, 52 + i * 60, 232, 46, m_Speaker.Speech[ m_Page * 4 + i ].ToString(), false, false ) );
				}
