...
public class RandomEncounterEngine
{
    ...
    private static string               m_EncountersFile = "./Scripts/Custom/RandomEncounters/RandomEncounters.xml";
    //----------------------------------------------------------------------
...
//        }
    ...
    public static void GenerateEncounters( string timerType )
    {
        ...
        foreach (PlayerMobile chosenMobile in chosenMobiles)
        {
            ...
            if( m_Debug ) Console.WriteLine( "RandomEncounters: Picking encounter for player=\"{0}, map=\"{1}\" ... ", 
                chosenMobile.Name, 
            ...
            foreach( EncounterSet encounterSet in possibleEncounters )
            {
                ...
                if ( draw <= encounterSet.Probability ) 
                {
                    ...
                    {
                        //Console.WriteLine("Validated player level as "+encounter.LevelType+":"+playerLevel );
