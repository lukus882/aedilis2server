		...
		public static List<string> DefaultEntries( int i )
		{
			...
			switch(i)
			{
				case 0: // Player
					break;
				case 1: // Counselor
					entries.Add("[Who"); entries.Add("[Where"); entries.Add("[Tele"); entries.Add("[M Tele"); entries.Add("[SpeedBoost");
					break;
				case 2: // GameMaster
					entries.Add("[Who"); entries.Add("[Where"); entries.Add("[Tele"); entries.Add("[M Tele"); entries.Add("[SpeedBoost"); for( int j = 0; j < 4; j++ ){entries.Add("-*UNUSED*-");}
					entries.Add("[Add"); entries.Add("[Move"); entries.Add("[Delete"); entries.Add("[Wipe"); entries.Add("[Kill");
					break;
				case 3: // Seer
					goto case 2;
				case 4: // Administrator
					entries.Add("[Admin"); entries.Add("[Where"); entries.Add("[Tele"); entries.Add("[M Tele"); entries.Add("[SpeedBoost"); for( int j = 0; j < 4; j++ ){entries.Add("-*UNUSED*-");}
					entries.Add("[Add"); entries.Add("[Move"); entries.Add("[Delete"); entries.Add("[Wipe"); entries.Add("[Kill");
					break;
				case 5: // Developer
					goto case 4;
