...
namespace Server.Gumps
{
	...
	public class GMPanel : Gump
	{
		private Mobile m_From;
		private GMPanelPage m_PageType;
		...
		public void AddPageButton( int x, int y, int buttonID, string text, GMPanelPage page, params GMPanelPage[] subPages )
		{
		...
		{
			CommandSystem.Register( "GMPanel", AccessLevel.GameMaster, new CommandEventHandler( Admin_OnCommand ) );
		}
		...
		{
			e.Mobile.SendGump( new GMPanel( e.Mobile, GMPanelPage.Clients, 0, null, null, null ) );
		}
		...
		public GMPanel( Mobile from, GMPanelPage pageType, int listPage, ArrayList list, string notice, object state ) : base( 50, 40 )
		{
			from.CloseGump( typeof( GMPanel ) );
			...
			AddPageButton( 10, 10, GetButtonID( 0, 0 ), "INFORMATION", GMPanelPage.Information_General, GMPanelPage.Information_Perf );
			AddPageButton( 10, 30, GetButtonID( 0, 1 ), "ADMINISTER", GMPanelPage.Administer, GMPanelPage.Administer_Access, GMPanelPage.Administer_Commands, GMPanelPage.Administer_Server, GMPanelPage.Administer_WorldBuilding, GMPanelPage.Administer_Access_Lockdown );
			AddPageButton( 10, 50, GetButtonID( 0, 2 ), "CLIENT LIST", GMPanelPage.Clients, GMPanelPage.ClientInfo );
			AddPageButton( 10, 70, GetButtonID( 0, 3 ), "ACCOUNT LIST", GMPanelPage.Accounts, GMPanelPage.Accounts_Shared, GMPanelPage.AccountDetails, GMPanelPage.AccountDetails_Information, GMPanelPage.AccountDetails_Characters, GMPanelPage.AccountDetails_Access, GMPanelPage.AccountDetails_Access_ClientIPs, GMPanelPage.AccountDetails_Access_Restrictions, GMPanelPage.AccountDetails_Comments, GMPanelPage.AccountDetails_Tags, GMPanelPage.AccountDetails_ChangeAccess, GMPanelPage.AccountDetails_ChangePassword );
			AddPageButton( 10, 90, GetButtonID( 0, 4 ), "FIREWALL", GMPanelPage.Firewall, GMPanelPage.FirewallInfo );
			...
			switch ( pageType )
			{
				case GMPanelPage.Information_General:
				{
					int banned = 0;
					int active = 0;
					...
					AddPageButton( 200, 20, GetButtonID( 0, 0 ), "General", GMPanelPage.Information_General );
					AddPageButton( 200, 40, GetButtonID( 0, 5 ), "Performance", GMPanelPage.Information_Perf );

					break;
				}
				case GMPanelPage.Information_Perf:
				{
				...
				case GMPanelPage.Administer_WorldBuilding:
				{
					...
					goto case GMPanelPage.Administer;
				}
				case GMPanelPage.Administer_Server:
				{
				...
				case GMPanelPage.Administer_Access_Lockdown:
				{
				...
				case GMPanelPage.Administer_Access:
				{
				...
				case GMPanelPage.Administer_Commands:
				{
				...
				case GMPanelPage.Administer:
				{
					AddPageButton( 200, 20, GetButtonID( 3, 0 ), "World Building", GMPanelPage.Administer_WorldBuilding );
					AddPageButton( 200, 40, GetButtonID( 3, 1 ), "Server", GMPanelPage.Administer_Server );
					AddPageButton( 200, 60, GetButtonID( 3, 2 ), "Access", GMPanelPage.Administer_Access, GMPanelPage.Administer_Access_Lockdown );
					AddPageButton( 200, 80, GetButtonID( 3, 3 ), "Commands", GMPanelPage.Administer_Commands );

					break;
				}
				case GMPanelPage.Clients:
				{
					if ( m_List == null )
					{
				...
				case GMPanelPage.Accounts_Shared:
				{
					if ( m_List == null )
				...
				case GMPanelPage.AccountDetails:
				{
					AddPageButton( 190, 10, GetButtonID( 5, 0 ), "Information", GMPanelPage.AccountDetails_Information, GMPanelPage.AccountDetails_ChangeAccess, GMPanelPage.AccountDetails_ChangePassword );
					AddPageButton( 190, 30, GetButtonID( 5, 1 ), "Characters", GMPanelPage.AccountDetails_Characters );
					AddPageButton( 190, 50, GetButtonID( 5, 13 ), "Access", GMPanelPage.AccountDetails_Access, GMPanelPage.AccountDetails_Access_ClientIPs, GMPanelPage.AccountDetails_Access_Restrictions );
					AddPageButton( 190, 70, GetButtonID( 5, 2 ), "Comments", GMPanelPage.AccountDetails_Comments );
					AddPageButton( 190, 90, GetButtonID( 5, 3 ), "Tags", GMPanelPage.AccountDetails_Tags );
					break;
				}
				case GMPanelPage.AccountDetails_ChangePassword:
				{
					...
					goto case GMPanelPage.AccountDetails;
				}
				case GMPanelPage.AccountDetails_ChangeAccess:
				{
					Account a = state as Account;
				...
				case GMPanelPage.AccountDetails_Information:
				{
					Account a = state as Account;
				...
				case GMPanelPage.AccountDetails_Access:
				{
					Account a = state as Account;
					...
					AddPageButton( 20, 150, GetButtonID( 5, 14 ), "View client addresses", GMPanelPage.AccountDetails_Access_ClientIPs );
					AddPageButton( 20, 170, GetButtonID( 5, 15 ), "Manage restrictions", GMPanelPage.AccountDetails_Access_Restrictions );

					goto case GMPanelPage.AccountDetails;
				}
				case GMPanelPage.AccountDetails_Access_ClientIPs:
				{
					Account a = state as Account;
					...
					goto case GMPanelPage.AccountDetails_Access;
				}
				case GMPanelPage.AccountDetails_Access_Restrictions:
				{
					Account a = state as Account;
				...
				case GMPanelPage.AccountDetails_Characters:
				{
					Account a = state as Account;
				...
				case GMPanelPage.AccountDetails_Comments:
				{
					Account a = state as Account;
				...
				case GMPanelPage.AccountDetails_Tags:
				{
					Account a = state as Account;
		...
		public static void BanShared_Callback( Mobile from, bool okay, object state )
		{
			...
			from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_ClientIPs, 0, null, notice, state ) );
		...
		public static void AccountDelete_Callback( Mobile from, bool okay, object state )
		{
			...
			if ( okay )
			{
				...
				from.SendGump( new GMPanel( from, GMPanelPage.Accounts, 0, null, String.Format( "{0} : The account has been deleted.", a.Username ), null ) );
			}
			else
			{
				from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Information, 0, null, "You have chosen not to delete the account.", state ) );
			}
		}
		...
		public static void ResendGump_Callback( Mobile from, object state )
		{
			...
			from.SendGump( new GMPanel( from, GMPanelPage.Accounts, page, list, null, rads ) );
		}
		...
		public static void Firewall_Callback( Mobile from, bool okay, object state )
		{
			...
			from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_ClientIPs, 0, null, notice, a ) );
		}
		...
		public override void OnResponse( Server.Network.NetState sender, RelayInfo info )
		{
			...
			if ( m_PageType == GMPanelPage.Accounts )
			{
			...
			switch ( type )
			{
				case 0:
				{
					...
					switch ( index )
					{
						case 0: page = GMPanelPage.Information_General; break;
						case 1: page = GMPanelPage.Administer; break;
						case 2: page = GMPanelPage.Clients; break;
						case 3: page = GMPanelPage.Accounts; break;
						case 4: page = GMPanelPage.Firewall; break;
						case 5: page = GMPanelPage.Information_Perf; break;
						default: return;
					}

					from.SendGump( new GMPanel( from, page, 0, null, null, null ) );
					break;
				}
				case 1:
				{
					switch ( index )
					{
						case 0:
						{
							if ( m_List != null && m_ListPage > 0 )
								from.SendGump( new GMPanel( from, m_PageType, m_ListPage - 1, m_List, null, m_State ) );
				...
				{
					string notice = null;
					GMPanelPage page = GMPanelPage.Administer;

					if ( index >= 500 )
						page = GMPanelPage.Administer_Access_Lockdown;
					else if ( index >= 400 )
						page = GMPanelPage.Administer_Commands;
					else if ( index >= 300 )
						page = GMPanelPage.Administer_Access;
					else if ( index >= 200 )
						page = GMPanelPage.Administer_Server;
					else if ( index >= 100 )
						page = GMPanelPage.Administer_WorldBuilding;

					switch ( index )
					{
						case  0: page = GMPanelPage.Administer_WorldBuilding; break;
						case  1: page = GMPanelPage.Administer_Server; break;
						case  2: page = GMPanelPage.Administer_Access; break;
						case  3: page = GMPanelPage.Administer_Commands; break;
						...
						case 303: page = GMPanelPage.Administer_Access_Lockdown; break;
					...
					from.SendGump( new GMPanel( from, page, 0, null, notice, null ) );
					...
					switch ( index )
					{
						...
						case 1:
						{
							...
							if ( results.Count == 1 )
							{
								...
								if ( state is Mobile )
									from.SendGump( new GMPanel( from, GMPanelPage.ClientInfo, 0, null, "One match found.", state ) );
								else if ( state is Account )
									from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Information, 0, null, "One match found.", state ) );
								else
									from.SendGump( new GMPanel( from, GMPanelPage.Clients, 0, results, "One match found.", null ) );
							}
							else
							{
								from.SendGump( new GMPanel( from, GMPanelPage.Clients, 0, results, notice == null ? (results.Count == 0 ? "Nothing matched your search terms." : null) : notice, null ) );
							}
						...
						default:
						{
							...
							if ( m_List != null && index >= 0 && index < m_List.Count )
							{
								...
								if ( m != null )
									from.SendGump( new GMPanel( from, GMPanelPage.ClientInfo, 0, null, null, m ) );
								else if ( a != null )
									from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Information, 0, null, null, a ) );
							}
				...
				case 5:
				{
					switch ( index )
					{
						case 0: from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Information, 0, null, null, m_State ) ); break;
						case 1: from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Characters, 0, null, null, m_State ) ); break;
						case 2: from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Comments, 0, null, null, m_State ) ); break;
						case 3: from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Tags, 0, null, null, m_State ) ); break;
						case 13: from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access, 0, null, null, m_State ) ); break;
						case 14: from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_ClientIPs, 0, null, null, m_State ) ); break;
						case 15: from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_Restrictions, 0, null, null, m_State ) ); break;
						...
						case 6:
						{
							...
							from.SendGump( new GMPanel( from, dispAccount != null ? GMPanelPage.AccountDetails_Information : m_PageType, m_ListPage, m_List, notice, dispAccount != null ? dispAccount : m_State ) );
							break;
						}
						case 7:
						{
							...
							if ( results.Count == 1 )
								from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Information, 0, null, "One match found.", results[0] ) );
							else
								from.SendGump( new GMPanel( from, GMPanelPage.Accounts, 0, results, notice == null ? (results.Count == 0 ? "Nothing matched your search terms." : null) : notice, new ArrayList() ) );

							break;
						}
						case 8: from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_ChangePassword, 0, null, null, m_State ) ); break;
						case 9: from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_ChangeAccess, 0, null, null, m_State ) ); break;
						case 10: case 11:
						{
							...
							from.SendGump( new GMPanel( from, m_PageType, m_ListPage, m_List, String.Format( "The account has been {0}.", a.Banned ? "banned" : "unbanned" ), m_State ) );
						...
						case 12:
						{
							...
							string notice;
							GMPanelPage page = GMPanelPage.AccountDetails_ChangePassword;
						...
						case 16: // view shared
						{
							...
							{
								from.SendGump( new GMPanel( from, GMPanelPage.Accounts, 0, list, null, new ArrayList() ) );
							}
							else if ( a.LoginIPs.Length > 0 )
							{
								from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_ClientIPs, 0, null, "There are no other accounts which share an address with this one.", m_State ) );
							}
							else
							{
								from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_ClientIPs, 0, null, "This account has not yet been accessed.", m_State ) );
							}
						...
						case 17: // ban shared
						{
							...
							{
								from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_ClientIPs, 0, null, "There are no accounts which share an address with this one.", m_State ) );
							}
							else
							{
								from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_ClientIPs, 0, null, "This account has not yet been accessed.", m_State ) );
						...
						case 19: // add
						{
							...
							from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_Restrictions, 0, null, notice, m_State ) );
						...
						case 24:
						{
							...
							if ( newLevel < from.AccessLevel )
							{
								...
								from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Information, 0, null, "The access level has been changed.", m_State ) );
							}
						...
						{
							from.SendGump( new GMPanel( from, GMPanelPage.Accounts_Shared, 0, null, null, null ) );
							break;
						}
						case 27: // Ban marked
						{
						...
						case 29: // Mark all
						{
							...
							from.SendGump( new GMPanel( from, GMPanelPage.Accounts, m_ListPage, m_List, null, new ArrayList( list ) ) );
						...
						case 30: // View all empty accounts
						{
							...
							if ( results.Count == 1 )
								...
								from.SendGump( new GMPanel( from, GMPanelPage.Accounts, 0, results, (results.Count == 0 ? "Nothing matched your search terms." : null), new ArrayList() ) );
							...
							else
							{
								...
								if ( m_List != null && index >= 0 && index < m_List.Count )
								{
									if ( m_List[index] is Account )
										from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Information, 0, null, null, m_List[index] ) );
									else if ( m_List[index] is DictionaryEntry )
										from.SendGump( new GMPanel( from, GMPanelPage.Accounts, 0, (ArrayList)(((DictionaryEntry)m_List[index]).Value), null, new ArrayList() ) );
								}
							}
				...
				case 6:
				{
					switch ( index )
					{
						case 0:
						{
							...
							if ( results.Count == 1 )
								from.SendGump( new GMPanel( from, GMPanelPage.FirewallInfo, 0, null, "One match found.", results[0] ) );
							else if ( results.Count > 1 )
								from.SendGump( new GMPanel( from, GMPanelPage.Firewall, 0, results, String.Format( "Search results for : {0}", match ), m_State ) );
							else
								from.SendGump( new GMPanel( from, m_PageType, m_ListPage, m_List, notice == null ? "Nothing matched your search terms."  : notice, m_State ) );
						...
						case 1:
						{
							...
							if ( text == null || text.Length == 0 )
							{
								from.SendGump( new GMPanel( from, m_PageType, m_ListPage, m_List, "You must enter an address or pattern to add.", m_State ) );
							}
							else if ( !Utility.IsValidIP( text ) )
							{
								from.SendGump( new GMPanel( from, m_PageType, m_ListPage, m_List, "That is not a valid address or pattern.", m_State ) );
							}
							else
							{
								object toAdd;
								...
								Firewall.Add( toAdd );
								from.SendGump( new GMPanel( from, GMPanelPage.FirewallInfo, 0, null, String.Format( "{0} : Added to firewall.", toAdd ), toAdd ) );
							}
						...
						case 2:
						{
							...
							from.SendGump( new GMPanel( from, m_PageType, m_ListPage, m_List, "Target the player to firewall.", m_State ) );
							break;
						}
						case 3:
						{
							if ( m_State is IPAddress || m_State is String )
							{
								...
								from.SendGump( new GMPanel( from, GMPanelPage.Firewall, 0, null, String.Format( "{0} : Removed from firewall.", m_State ), null ) );
							}
						...
						default:
						{
							...
							if ( m_List != null && index >= 0 && index < m_List.Count )
								from.SendGump( new GMPanel( from, GMPanelPage.FirewallInfo, 0, null, null, m_List[index] ) );
				...
				case 7:
				{
					...
					switch ( index )
					{
						...
						case 14:
						{
							from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Information, 0, null, null, m.Account ) );
							sendGump = false;
							break;
						}
					}
					...
					if ( sendGump )
						from.SendGump( new GMPanel( from, GMPanelPage.ClientInfo, 0, null, notice, m_State ) );
				...
				case 8:
				{
					if ( m_List != null && index >= 0 && index < m_List.Count )
					{
						...
						if ( m_PageType == GMPanelPage.AccountDetails_Access_ClientIPs )
						{
						...
						else if ( m_PageType == GMPanelPage.AccountDetails_Access_Restrictions )
						{
							...
							from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_Restrictions, 0, null, String.Format( "{0} : Removed from list.", m_List[index] ), a ) );
						}
					}
					...
					if ( m_List != null && index >= 0 && index < m_List.Count )
					{
						if ( m_PageType == GMPanelPage.AccountDetails_Access_ClientIPs )
						{
							...
							if ( list.Count > 1 || (list.Count == 1 && !list.Contains( a )) )
								...
								from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Access_ClientIPs, 0, null, "There are no other accounts which share that address.", m_State ) );
						}
					}
		...
		private class AddCommentPrompt : Prompt
		{
			...
			{
				from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Comments, 0, null, "Request to add comment was canceled.", m_Account ) );
			}
			...
			public override void OnResponse( Mobile from, string text )
			{
				if ( m_Account != null )
				{
					...
					from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Comments, 0, null, "Comment added.", m_Account ) );
				}
			}
		}
		...
		private class AddTagNamePrompt : Prompt
		{
			...
			public override void OnCancel( Mobile from )
			{
				from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Tags, 0, null, "Request to add tag was canceled.", m_Account ) );
			}
		...
		private class AddTagValuePrompt : Prompt
		{
			...
			public override void OnResponse( Mobile from, string text )
			{
				if ( m_Account != null )
				{
					...
					from.SendGump( new GMPanel( from, GMPanelPage.AccountDetails_Tags, 0, null, "Tag added.", m_Account ) );
				}
			}
		}
