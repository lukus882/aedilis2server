		...
		private static string[] m_Messages = ( TestCenter.Enabled ?
			...
			new string[]
				{	//Yes, this message is a pathetic message, It's suggested that you change it.
					"Welcome to Aedilis",
					"If you have not already done so, you may want to visit our website for more info about our shard.",
					"You can get there by double clicking on the welcome book in your pack",
					"or by going to www.aedilis.us in your web browser.",
					"You will find our rules, features, chat room, and much more by visiting our website.",
					"If you are looking for staff help you won't find staff members sitting around in the world",
					"You can find us in the irc chat room via our website chat link or by typing [irc blah blah",
					"I hope you enjoy your stay in our world",
					"-Stormwolf"
				} );
