...
{
	public class NewbCarpQuestGump : Gump
	{
		public NewbCarpQuestGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(250, 151, 1153, @"New Player Carpentry Quest");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "If you would like to master the arts of carpentry, I can help you by giving your special items. But first, you must prove your dedication to this fine art by getting a few things for me. First craft for me 10 boards, 1 wooden box , and 1 wooden chair.", true, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( NewbCarpQuestGump ) );
					from.AddToBackpack(new NewbCarpMarker1());
					break;
				}
				case 1:
				{
