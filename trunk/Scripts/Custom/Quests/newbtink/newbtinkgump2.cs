...
{
	public class NewbTinkQuestGump2 : Gump
	{
		public NewbTinkQuestGump2( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279,  "Thank you for bringing back the items for me. You have proven that you understand the workings of the tinkering skill. Please accept this reward from me.", true, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( NewbTinkQuestGump2 ) );
					break;
				}
