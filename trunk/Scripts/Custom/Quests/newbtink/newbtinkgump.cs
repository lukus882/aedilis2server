...
{
	public class NewbTinkQuestGump : Gump
	{
		public NewbTinkQuestGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(250, 151, 1153, @"New Player Tink Quest");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "If you would like to master the arts of tinkering, I can help you by giving your special items. But first, you must prove your dedication to this fine art by getting a few things for me. First craft for me 1 goblet, 1 key ring, and 1 skinning knife. Make sure when you come back that you have all your other knives and keyrings in a safe place for I will pick one at random in your backpack. Consider yourself warned!", true, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( NewbTinkQuestGump ) );
					from.AddToBackpack(new NewbTinkMarker1());
					break;
				}
				case 1:
				{
