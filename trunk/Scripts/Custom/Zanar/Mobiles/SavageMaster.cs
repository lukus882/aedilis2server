...
{
	[CorpseName( "a savage master corpse" )]
	public class SavageSlaveMaster : BaseCreature
	{
		[Constructable]
		public SavageSlaveMaster() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.15, 0.4 )
		{
			...
			SetSkill( SkillName.Fencing, 85.5, 105.0 );
			SetSkill( SkillName.Healing, 80.3, 95.0 );
			SetSkill( SkillName.Macing, 72.5, 95.0 );
			SetSkill( SkillName.Poisoning, 80.0, 90.5 );
			SetSkill( SkillName.MagicResist, 90.5, 105.0 );
			...
			PackItem( new Bandage( Utility.RandomMinMax( 5, 22 ) ) );
		...
		public SavageSlaveMaster( Serial serial ) : base( serial )
		{
		}
