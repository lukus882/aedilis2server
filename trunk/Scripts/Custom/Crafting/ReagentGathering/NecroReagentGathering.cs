...
{
	public class NecroReagentGathering : HarvestSystem
	{
...
*/
		...
		private static NecroReagentGathering m_System;

		public static NecroReagentGathering System
		{
			get
			{
				if ( m_System == null )
					m_System = new NecroReagentGathering();
